...
class Vgg16GAPUnfreeze(torch.nn.Module):
    def __init__(self, name, outputs, unfreeze=0):
        super(Vgg16GAPUnfreeze, self).__init__()
        self.name = name + '_vgg16_gap_unfreeze_' + str(unfreeze)
        print(self.name)
